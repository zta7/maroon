...
export {}
declare global {
  const IconMdiChevronDoubleLeft: typeof import('~icons/mdi/chevron-double-left')['default']
  const IconMdiCoffee: typeof import('~icons/mdi/coffee')['default']
  const IconMdiCog: typeof import('~icons/mdi/cog')['default']
  const IconMdiCommentTextOutline: typeof import('~icons/mdi/comment-text-outline')['default']
