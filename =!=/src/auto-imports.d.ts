...
declare global {
  ...
  const IconMdiCol: typeof import('~icons/mdi/col')['default']
  const IconMdiSearch: typeof import('~icons/mdi/search')['default']
  const IconMdiSharpBook: typeof import('~icons/mdi/sharp-book')['default']
  const IconMdiSharpSearch: typeof import('~icons/mdi/sharp-search')['default']
  const IconMdiSharpbook: typeof import('~icons/mdi/sharpbook')['default']
